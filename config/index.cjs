...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'Y5jz89a7fqhbi-DEPIT-hUFEP9wtRDLjb0PIsHr93OE',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      //自加horoscopeDate: '12-27',
      festivals: [
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
       //自加 { keyword: 'marry_day', date: '2022-09-09' },
      ],
    },
  ],
  ...
  CALLBACK_TEMPLATE_ID: 'PxHCO0X7ElEuBrDggF9g71e_Yx7TzmJl96mmbCXV_Oc',
